...
class Config:
    ...
    def __init__(self, cfg_id, test=False):
        ...
        self.actcc_dir = '%s/actcc' % self.cfg_dir
        os.makedirs(self.model_dir, exist_ok=True)
        os.makedirs(self.result_dir, exist_ok=True)
        os.makedirs(self.log_dir, exist_ok=True)
        os.makedirs(self.tb_dir, exist_ok=True)
        os.makedirs(self.actcc_dir, exist_ok=True)
        ...
        #TB
        self.transi_length = cfg.get('transi_length', 50)
        self.transi_epoch = cfg.get('transi_epoch', 200)

        self.cc_model_path = os.path.join(self.actcc_dir, 'actcc_%04d.p')
